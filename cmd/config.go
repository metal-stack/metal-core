...
type Config struct {
	...
	SyncCronSchedule         string        `required:"false" default:"*/20 * * * * *" desc:"cron schedule at which the sync should happen, has 6 fields including the seconds as first field" split_words:"true"`
	SyncDelay                time.Duration `required:"false" default:"0s" desc:"delay of which the sync should be started after the cron_schedule triggered" split_words:"true"`
