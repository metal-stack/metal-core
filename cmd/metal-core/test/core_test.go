...
func (a *apiHandlerCoreTest) SetMachineLEDStateOn(machineID, description string) error {
	return nil
}

func (a *apiHandlerCoreTest) SetMachineLEDStateOff(machineID, description string) error {
	return nil
}
